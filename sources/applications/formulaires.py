...
'''
	def __init__(self,*args,**kwargs):
		...
		self.fields['nom']=forms.CharField(label="Nom",initial=self.nom,required=True)
		self.fields['criticite']=forms.CharField(label='Criticite',initial=criticite,widget=forms.Select( choices=CHOIX_CRITICITE),required=True)
	...
	def clean_criticite(self):
		...
		liste_criticite=['Critical','High','Medium','Low',None]
