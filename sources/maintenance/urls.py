...
urlpatterns = [
    ...
    url(r'testConnectionMail/$',connectionMail,name='connectionMail'),
    url(r'edit-configuration/$',editConfig,name='editConfig'),
    ...
    url(r'validerInfosRapports/$',validerInfosRapports,name='validerInfosRapports'),
