...
AUTEUR=Config.get('General','Auteur')
SOCIETE=Config.get('General','Societe')
LOGO=BASE+"static/img/"+Config.get('General','Logo')
...
WHERE date_detection=%s or date_correction=%s ORDER BY ip_hote ASC
''',[date_scan,date_scan])
