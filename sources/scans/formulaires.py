...
('dimanche','dimanche')
		...
		self.fields['nmapOptions']=forms.CharField(label='Options Nmap',initial=self.nmapOptions,required=False,max_length=20)
...
class scanManuel(forms.Form):
	...
	def __init__(self,*args,**kwargs):
		...
		self.fields['nmapOptions']=forms.CharField(label='Options Nmap',initial='-A -sS -sU',required=False,max_length=20)
