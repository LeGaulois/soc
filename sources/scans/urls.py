...
urlpatterns = [
	url(r'status-scans-manuels/$', views.status_scans_manuels,name='status_scans_manuels'),
	...
	url(r'parametres-scan-manuel/(?P<id_scan>\d+)/$', views.parametresScanManuel,name='parametresScanManuel'),
